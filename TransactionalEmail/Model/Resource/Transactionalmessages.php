 ...
 * #1877
 */
class Listrak_TransactionalEmail_Model_Resource_Transactionalmessages extends Mage_Core_Model_Resource_Db_Abstract
{
    protected function _construct()
    {  
        $this->_init('transactionalemail/transactionalmessages', 'id');
    }
